...
class MoviePlayerViewController: UIViewController {
    ...
    private func updateGroupSession(_ groupSession: GroupSession<MovieWatchingActivity>?) {
        // TODO: Step 3
        // 1. Coordinate AVPlayer playbackCoordinator with session
    ...
    func performWhatHappened() {
        ...
        // TODO: Step 6
        // 1. Begin .whatHappened suspension on AVPlayer playbackCoordinator
        // 2. End suspention after delay
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + delay) {
            // Non-SharePlay: Resume playback at normal rate
